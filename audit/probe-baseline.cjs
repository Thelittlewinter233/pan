...
(async () => {
  ...
  fs.writeFileSync(path.join(dir,'current-main-probes.json'),JSON.stringify({baseline:'591367a65f88e9d5270e8e99920ef5448d1d68c9',runtime:'real Zustand; transpiled unmodified product TS; mocked API/UI',snapshots},null,2));
